...
While the cloud adoption team is migrating or implementing the first workload, the cloud strategy team can begin prioritizing the remaining applications and workloads.
